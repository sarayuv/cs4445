...
def test_python_environment():
    ...
    assert len(set(['pytest', 'mypy', 'numpy', 'flask', 'torch']) - installed_pkg) ==0 # Check if any required package is missing. If missing, please follow the instructions at the begining of problem1.py to install the packages
